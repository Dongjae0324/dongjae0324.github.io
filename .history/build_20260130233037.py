...
def get_personal_data():
    ...
    bio_text = """
I am a first-year master's student in Computer Science at <a href="https://www.yonsei.ac.kr/en_sc/" target="_blank">Yonsei University</a>,<br>
...
<ul style="margin-top: 0.5em; padding-left: 1.2em;">
    <li><span style="font-weight: 600;">Safety &amp; Privacy</span> <a href="#pub-C1" class="cite-link">[C1]</a><a href="#pub-C2" class="cite-link">[C2]</a><a href="#pub-C5" class="cite-link">[C5]</a><a href="#pub-C6" class="cite-link">[C6]</a></li>
    <li><span style="font-weight: 600;">Methodologies (Understanding)</span> <a href="#pub-C4" class="cite-link">[C4]</a><a href="#pub-C7" class="cite-link">[C7]</a></li>
    <li><span style="font-weight: 600;">Efficient AI</span> <a href="#pub-P1" class="cite-link">[P1]</a><a href="#pub-C3" class="cite-link">[C3]</a></li>
    </ul>
    
<p style="margin-top: 1em;">I have prior experience in <em>Continual Learning</em> applied to computer vision, specifically Object Detection (See Awards). <br>
