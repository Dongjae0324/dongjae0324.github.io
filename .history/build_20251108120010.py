...
def get_personal_data():
    ...
    <p>I am broadly interested in generative models, focusing on three specific areas:</p>

    <ul>
        <li><span style="color:#0046FF;">Safety and Privacy:</strong></span> Ensuring the responsible and secure development and deployment of generative systems.</li>
