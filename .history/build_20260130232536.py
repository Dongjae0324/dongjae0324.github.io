...
def get_personal_data():
    ...
    bio_text = """
I am a master's student in Computer Science at <a href="https://www.yonsei.ac.kr/en_sc/" target="_blank">Yonsei University</a>, 
...
<ul style="margin-top: 0.5em; padding-left: 1.2em;">
    <li><span style="font-weight: 600;">Safety &amp; Privacy</span> <a href="#pub-C1" class="cite-link">[C1]</a><a href="#pub-C2" class="cite-link">[C2]</a><a href="#pub-C5" class="cite-link">[C5]</a><a href="#pub-C6" class="cite-link">[C6]</a><a href="#pub-C7" class="cite-link">[C7]</a></li>
    <li><span style="font-weight: 600;">Methodologies</span> <a href="#pub-C1" class="cite-link">[C1]</a><a href="#pub-C2" class="cite-link">[C2]</a><a href="#pub-C3" class="cite-link">[C3]</a><a href="#pub-C4" class="cite-link">[C4]</a><a href="#pub-C6" class="cite-link">[C6]</a></li>
    <li><span style="font-weight: 600;">Efficient AI</span> <a href="#pub-P1" class="cite-link">[P1]</a><a href="#pub-C3" class="cite-link">[C3]</a><a href="#pub-C4" class="cite-link">[C4]</a></li>
    </ul>
...
def get_paper_entry(entry_key, entry, paper_num=None):
    ...
    # Paper ID for citation linking - use pub_id if available, otherwise use paper_num
    paper_ref = pub_id if pub_id else paper_num
    paper_id_attr = f'id="pub-{paper_ref}"' if paper_ref else ''
    ...
    posts = [
        {
            ...
            'date': 'Jan 2026',
            'excerpt': 'An introduction to score-based diffusion models and their applications in generative AI. We explore the mathematical foundations and practical implementations...',
            'url': 'blog/understanding-diffusion-models.html'
        },
        {
            'title': 'Safety and Privacy in Generative Models',
            'date': 'Dec 2025',
            'excerpt': 'Discussing key challenges and solutions for ensuring privacy and safety in large-scale generative models. Covering memorization, unlearning, and alignment techniques...',
            'url': 'blog/safety-privacy-generative-models.html'
        },
        {
            'title': 'Efficient Training Strategies for Large Models',
            'date': 'Nov 2025',
            'excerpt': 'An overview of quantization, low-rank adaptation, and other efficient training methods. We benchmark various approaches and discuss their trade-offs...',
            'url': 'blog/efficient-training-strategies.html'
        }
    ]
        ...
        <section id="about" class="profile-section">
            <div class="profile-header">
                <div class="profile-image">
                    <img src="assets/img/profile2.jpg" alt="{data['name'][0]} {data['name'][1]}">
                </div>
