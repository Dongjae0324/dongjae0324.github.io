...
def get_personal_data():
    ...
    I am specifically broadly interested in generative models
    1) <span style="color:#0046FF;">Safety and reliableness</span> 
    2) Enhancing methodologies (sampling, architectures) - Diffusion language models.
    3) <span style="color:#03A791;">efficient AI</span> for real-world deployment
