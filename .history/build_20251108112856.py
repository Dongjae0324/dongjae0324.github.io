...
def get_paper_entry(entry_key, entry):
    ...
    if 'award' in entry.fields.keys():
        s += f"""<span style="font-style: bold;">{entry.fields['booktitle']}</span>, {entry.fields['year']} <span style="color: blue;">({entry.fields['award']})</span> <br>"""
    else:
        s += f"""<span style="font-style: bold;">{entry.fields['booktitle']}</span>, {entry.fields['year']} <br>"""
