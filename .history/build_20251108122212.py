...
def get_personal_data():
    ...
    <ul>
        ...
        <li><span style="color:black; font-weight: 450;">Methodologies:</span> Advancing core techniques, including novel sampling methods and new architectures like diffusion language models.</li>
