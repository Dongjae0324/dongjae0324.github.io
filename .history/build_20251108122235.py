...
def get_personal_data():
    ...
    <ul>
        <li><span style="color:#0046FF; font-weight: 550">Safety and Privacy:</span> Ensuring the responsible deployment of generative systems.</li>
        
        <li><span style="color:black; font-weight: 550;">Methodologies:</span> Advancing core techniques, including novel sampling methods and new architectures like diffusion language models.</li>
        
        <li><span style="color:#03A791; font-weight: 550;">Efficient AI:</span> Optimizing models for real-world deployment and resource-constrained environments.</li>
    </ul>
