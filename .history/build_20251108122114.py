...
def get_personal_data():
    ...
    <ul>
        ...
        <li>Methodological Enhancements: Advancing core techniques, including novel sampling methods and new architectures like diffusion language models.</li>
        
        <li><span style="color:#03A791; font-weight: 400;">Efficient AI:</span> Optimizing models for real-world deployment and resource-constrained environments.</li>
    </ul>
